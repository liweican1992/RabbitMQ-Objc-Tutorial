...
@property (nonatomic, weak) id<RMQSender> sender;
@property (nonatomic, strong) RMQConnectionConfig *config;
@property (nonatomic, strong) void (^completionHandler)(NSNumber *heartbeatTimeout);
