...
@property (nonatomic, assign) RMQBasicConsumeOptions options;
@property (nonatomic, strong) NSString *tag;
@property (nonatomic, weak) id<RMQChannel> channel;
@property (nonatomic, strong) RMQConsumerDeliveryHandler deliveryHandler;
@property (nonatomic, strong) RMQConsumerCancellationHandler cancellationHandler;
@end
